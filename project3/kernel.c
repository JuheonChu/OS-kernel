...
void main(){
  ...
  //Testing for executeProgram(char * name, int segment)
  //makeInterrupt21();
  //interrupt(0x21, 0x04, "uprog1\0", 0x2000, 0);
  //interrupt(0x21, 0x00, "Done!\n\r\0", 0, 0); //will not be executed..

  //Testing for terminate()
  //makeInterrupt21();
  //interrupt(0x21, 0x04, "uprog2\0", 0x2000, 0); //uprog2 will make a system call terminate()
  //interrupt(0x21, 0x00, "over..\n\r\0", 0, 0);
